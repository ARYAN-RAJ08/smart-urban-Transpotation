                            ...
                            <div class="stat-card" role="region" aria-label="Total Routes Statistics">
                                ...
                                <div class="mt-3">
                                    <span class="text-success">
                                        ...
                                        {{ round(($activeRoutes / $totalRoutes) * 100) }}% Active
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="stat-card" role="region" aria-label="Active Routes Statistics">
                                ...
                                <div class="mt-3">
                                    <span class="text-success">
                                        <i class="fas fa-arrow-up me-1" aria-hidden="true"></i>
                                        {{ round(($activeRoutes / $totalRoutes) * 100) }}% of Total
                                    </span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stat-card" role="region" aria-label="Delayed Routes Statistics">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h3 class="mb-0">{{ $delayedRoutes }}</h3>
                                    </div>
                                ...
                                <div class="mt-3">
                                    <span class="text-warning">
                                        ...
                                        {{ round(($delayedRoutes / $totalRoutes) * 100) }}% of Total
                                    </span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stat-card" role="region" aria-label="Utility Usage Statistics">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h3 class="mb-0">{{ $totalUtilityUsage }}</h3>
                                    </div>
        ...
        <div class="col-12">
            <div class="card h-100">
                ...
                <div class="card-body p-0">
                    <div id="trafficMap" style="height: 400px;" data-zones='@json($trafficZones)' role="img" aria-label="Traffic Zones Map"></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover" role="grid">
                            ...
                            <tbody>
                                @foreach($utilityUsage as $usage)
                                <tr>
                                    <td>{{ $usage->date ? $usage->date->format('Y-m-d') : 'N/A' }}</td>
                                    <td>{{ $usage->utility_type }}</td>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var trafficZones = @json($trafficZones);
